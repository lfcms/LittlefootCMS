<html>
	<head>
		...
		<style type="text/css">
			...
			body { margin: 0; padding: 0; font-family: Arial; background: #CCC;}
	...
	<body>
		...
		<table>
			...
			<tr>
				<td class="mod">
					[<a href="%baseurl%index.php/cms_deploy/rm/<?php echo $row['id'] ?>/">x</a>]
				</td>
				<td class="note">
					<a href="%baseurl%index.php/cms_deploy/listitems/<?php echo $row['id'] ?>/">
		...
		<fieldset>
			...
			<form action="%baseurl%index.php/cms_deploy/update/<?php echo isset($save) ? $save['id'].'/' : ''; ?>" method="post" id="addnote">
				<ul>
					<?php echo isset($save) ? '<li>[<a href="%baseurl%index.php/cms_deploy/listitems/">Create New / Deselect Current</a>]</li>' : ''; ?>
