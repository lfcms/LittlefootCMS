<h3>References <?php if($category != '') echo ' / '.$category; echo ' / '.ucfirst($status); ?></h3>
<div id="categories">
	<h4>Categories</h4>
...
$status_options = array('open', 'archive');
$nav = array();
...
<div id="note">
	<h4>References [<a href="%appurl%newarticle/<?php if($category != '') echo urlencode($category); ?>">New</a>] - <?php echo implode(' | ', $nav); ?></h4>
	<ul>
	<?php
