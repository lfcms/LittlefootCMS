<html>
	...
	<body>
		...
		<table>
			...
			<tr>
				<td class="mod">
					[<a href="%baseurl%index.php/todo/rm/<?php echo $row['id'] ?>/">x</a>]
				</td>
				<td class="note">
					<a href="%baseurl%index.php/todo/listitems/<?php echo $row['id'] ?>/">
		...
		<fieldset>
			...
			<form action="%baseurl%index.php/todo/update/<?php echo isset($save) ? $save['id'].'/' : ''; ?>" method="post" id="addnote">
				<ul>
					<?php echo isset($save) ? '<li>[<a href="%baseurl%index.php/todo/listitems/">Create New / Deselect Current</a>]</li>' : ''; ?>
